...
# Array copy dari calssnames untuk pengecekan agar absen hanya bisa sekli
        ...
        for encodeFace, faceLoc in zip(encodesCurFrame, facesCurFrame):
            ...
            if matches[matchIndex]:
                ...
                if name in classNames:
                    if name in student: # Ketika nama tidak ada di array student maka tidak bisa absen lagi
                        student.remove(name)
...
def retake():
    ...
    while True:
        ...
        if k%256 == 27:
            ...
            # Biar pas selesai ambil foto array student gabakal ke reload lagi dan cuman ketambahan nama siswa baru
            student = student.append(name + "_" + NPM )
            break
    recognition ()
